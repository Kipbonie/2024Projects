...
$frameworks = array(
  "NIST" => array(
    "questions" => array(
      1 => array(
        "text" => "Do you have a documented process for classifying and managing data based on its sensitivity and criticality (Function: Identify)?",
      ...
      2 => array(
        "text" => "Are there measures in place to identify and manage access control risks, ensuring that only authorized personnel can access sensitive information (Function: Protect)?",
      ...
      3 => array(
        "text" => "How is the organization's capability to detect cybersecurity events assessed, and what tools or processes are in place for continuous monitoring (Function: Detect)?",
      ...
      4 => array(
        "text" => "Is there an incident response plan in place, and how frequently is it tested and updated to address new threats (Function: Respond)?",
      ...
      5 => array(
        "text" => "What measures are implemented to ensure the timely recovery of critical systems and data following a cybersecurity incident or disruption (Function: Recover)?",
      ...
      6 => array(
        "text" => "How are vulnerabilities in the organization's systems and software identified and addressed (e.g., patch management) (Function: Protect, Detect)?",
      ...
      7 => array(
        "text" => "Do you conduct regular cybersecurity awareness training for employees, and does it cover emerging threats and best practices (Function: Identify, Protect, Detect, Respond)?",
      ...
      8 => array(
        "text" => "How is the organization's cybersecurity program evaluated, and what metrics are used to measure its effectiveness (Function: Identify, Protect, Detect, Respond, Recover)?",
      ...
      9 => array(
        "text" => "Is there a process to regularly assess and manage risks associated with third-party service providers and their access to sensitive information (Function: Identify, Protect)?",
      ...
      10 => array(
        "text" => "Are there measures in place to ensure the secure configuration of hardware, software, and network components (Function: Protect, Detect)?",
      ...
      11 => array(
        "text" => "How is the organization's capability to respond to and recover from cybersecurity incidents communicated to relevant stakeholders (Function: Respond, Recover)?",
      ...
      12 => array(
        "text" => "Do you have a process to review and update incident response plans based on lessons learned from previous incidents (Function: Respond)?",
      ...
      13 => array(
        "text" => "Is there a documented process for continuous monitoring of cybersecurity controls and an assessment of their effectiveness (Function: Identify, Protect, Detect)?",
      ...
      14 => array(
        "text" => "How is threat intelligence collected, analyzed, and incorporated into your cybersecurity strategy (Function: Identify, Detect)?",
      ...
      15 => array(
        "text" => "Do you conduct regular tabletop exercises to test the organization's incident response and recovery capabilities (Function: Respond, Recover)?",
      ...
      // ... add more questions for other NIST CSF Functions and related frameworks 
    ),
  ),
...
<div class="bg-overlay"></div>
  <div class="container">
    ...
    <form method="post" action="assess6.php" onsubmit="return validateForm();">
